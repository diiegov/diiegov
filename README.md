...
const diego = {
  ...
  linguagens: ["PHP", "JavaScript", "Python", "HTML", "CSS"],
  bancoDeDados: ["MySQL", "SQLite"],
  aprendendoAgora: ["Frameworks Web", "Integração de sistemas"],
  hobbies: ["Projetos pessoais", "Estudar novas tecnologias", "Programar por diversão"]
};
```
...
![Diego Viana GitHub Stats](https://github-readme-stats.vercel.app/api?username=diego-viana&show_icons=true&theme=tokyonight)
![Top Langs](https://github-readme-stats.vercel.app/api/top-langs/?username=diego-viana&layout=compact&theme=tokyonight)

</div>

## 🎯 Metas para 2025

- 📌 Dominar desenvolvimento Full Stack com PHP e Python  
- 📌 Construir projetos completos com bancos de dados reais  
- 📌 Aprender e aplicar testes automatizados  
- 📌 Contribuir com projetos open source  
- 📌 Estagiar ou trabalhar como desenvolvedor júnior  
...
✨ *"Transformando códigos em soluções e ideias em projetos."* ✨  
